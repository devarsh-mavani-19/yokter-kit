...
import { DateTimePickerSize } from "../../types";
import { useTheme } from "../../hooks";
import { inputSizeConfig } from "../../constants";

export type UseGetDateTimePickerStylesProp = {
...
const calendarDims: Record<DateTimePickerSize, { cellSize: number; navFontSize: number; dayFontSize: number; headerFontSize: number }> = {
...
export type UseGetDateTimePickerStylesReturn = {
  // Trigger
  trigger: ViewStyle;
...
export const useGetDateTimePickerStyles = ({
  size = "md",
  disabled,
  error,
  focused,
}: UseGetDateTimePickerStylesProp): UseGetDateTimePickerStylesReturn => {
  ...
  const triggerText: TextStyle = {
    ...
    color: disabled ? colors.inputDisabledForeground : colors.inputForeground,
  };
